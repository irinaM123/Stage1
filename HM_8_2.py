    ...
    def __init__(self, *args):
        if len(args) == 3:
            ...
            try:
                ...
                if self.arg1 * self.arg2 * self.arg3 == 0 or self.arg1 < 0 or self.arg2 < 0 or self.arg3 < 0:
                    raise ValueError('Стороны должны быть положительными')
                if self.arg1 + self.arg2 < self.arg3 or self.arg1 + self.arg3 < self.arg2 or self.arg2 + self.arg3 < self.arg1:
