...
def repeats(our_str):
    new_str = ''
    index_new_str = 0
    while index_new_str < len(our_str):
        count = our_str.count(our_str[index_new_str], 0, index_new_str + 1)
        new_str = f"{new_str}{our_str[index_new_str]}_{count}"
        index_new_str = index_new_str + 1
    return new_str
